export default function PurchaseOrderDesign1Blank() {
  return (
    <>
      <style>{`
...
.meta { direction:rtl; display:flex; flex-wrap:wrap; gap:2mm 0; border:1px solid #30246C; border-radius:2mm; padding:3mm 4mm; font-size:9pt; color:#30246C; margin-bottom:3mm; }
...
<div className="meta">
  <div className="it"><b>رقم الطلب:</b> PO-2026-0087</div>
  <div className="it"><b>التاريخ:</b> 20 / 06 / 2026</div>
  <div className="it"><b>المورّد:</b> مؤسسة الرواد لمواد البناء</div>
  <div className="it"><b>جهة الاتصال:</b> مكتب المبيعات — 6 555 1234</div>
  <div className="it"><b>المشروع:</b> مشروع صيانة طرق الشعيبة</div>
  <div className="it"><b>تاريخ التوريد المطلوب:</b> 27 / 06 / 2026</div>
</div>
<table><thead><tr>
...
</tr></thead><tbody><tr><td>1</td><td className="d">بيس كورس Type II</td><td>طن</td><td>120</td><td>—</td><td>—</td></tr><tr><td>2</td><td className="d">أسمنت أسود (شكاير)</td><td>كيس</td><td>300</td><td>—</td><td>—</td></tr><tr><td>3</td><td className="d">حديد تسليح 12مم</td><td>طن</td><td>8</td><td>—</td><td>—</td></tr><tr><td>4</td><td className="d">خرسانة جاهزة C30</td><td>م٣</td><td>45</td><td>—</td><td>—</td></tr><tr><td>&nbsp;</td><td className="d"></td><td></td><td></td><td></td><td></td></tr><tr><td>&nbsp;</td><td className="d"></td><td></td><td></td><td></td><td></td></tr><tr><td>&nbsp;</td><td className="d"></td><td></td><td></td><td></td><td></td></tr></tbody>
