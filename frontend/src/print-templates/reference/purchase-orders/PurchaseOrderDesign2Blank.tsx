...
import styles from './PurchaseOrderDesign2.module.css';

export default function PurchaseOrderDesign2Blank() {
  return (
    <>
      <div className={styles.page}><div className={styles.p}>
<img className={styles.wm} src={logo} alt="" style={{display: 'none'}} />
...
<div className={styles.mbar}>
  <div className={styles.box}><div className={styles.k}>رقم الطلب</div><div className={styles.v}>PO-2026-0087</div></div>
  <div className={styles.box}><div className={styles.k}>التاريخ</div><div className={styles.v}>20 / 06 / 2026</div></div>
  <div className={styles.box}><div className={styles.k}>تاريخ التوريد المطلوب</div><div className={styles.v}>27 / 06 / 2026</div></div>
</div>
<div className={styles.party}><b>المورّد:</b> مؤسسة الرواد لمواد البناء &nbsp;&nbsp;|&nbsp;&nbsp; <b>جهة الاتصال:</b> مكتب المبيعات — 6 555 1234 <br /><b>المشروع:</b> مشروع صيانة طرق الشعيبة</div>
<table><thead><tr>
...
</tr></thead><tbody><tr><td>1</td><td className={styles.d}>بيس كورس Type II</td><td>طن</td><td>120</td><td>—</td><td>—</td></tr><tr><td>2</td><td className={styles.d}>أسمنت أسود (شكاير)</td><td>كيس</td><td>300</td><td>—</td><td>—</td></tr><tr><td>3</td><td className={styles.d}>حديد تسليح 12مم</td><td>طن</td><td>8</td><td>—</td><td>—</td></tr><tr><td>4</td><td className={styles.d}>خرسانة جاهزة C30</td><td>م٣</td><td>45</td><td>—</td><td>—</td></tr><tr><td>&nbsp;</td><td className={styles.d}></td><td></td><td></td><td></td><td></td></tr><tr><td>&nbsp;</td><td className={styles.d}></td><td></td><td></td><td></td><td></td></tr><tr><td>&nbsp;</td><td className={styles.d}></td><td></td><td></td><td></td><td></td></tr></tbody></table>
<div className={styles.tot}><div className={styles.cell}>الإجمالي (د.ك) : ___________</div></div>
