...
import styles from './RFQDesign3.module.css';

export default function RFQDesign3() {
  return (
    <>
...
<div className={styles.meta}>
  <b>رقم الطلب:</b> RFQ-2026-0153 <span className={styles.sep}>•</span> <b>التاريخ:</b> 20 / 06 / 2026 <span className={styles.sep}>•</span> <b>آخر موعد للعرض:</b> 24 / 06 / 2026 <span className={styles.sep}>•</span> <b>صلاحية العرض:</b> 30 يوماً<br />
  <b>إلى:</b> السادة / المورد المحترم <span className={styles.sep}>•</span> <b>المشروع:</b> توريد مواد لمشروع طرق – الكويت
</div>
<div className={styles.lead}>يرجى تقديم عرض أسعاركم للأصناف التالية:</div>
<table><thead><tr>
...
<div className={styles.grid2}>
  <div className={styles.b}><h4>ملاحظات</h4>يرجى تقديم العرض شاملاً سعر الوحدة ومدة التوريد وشروط الدفع، مع ختم وتوقيع المورد.</div>
  <div className={styles.b}><h4>شروط المورّد</h4>مدة التوريد: __________<br />شروط الدفع: __________<br />صلاحية العرض: __________</div>
</div>
