export default function RFQDesign2() {
  return (
    <>
      <style>{`
...
.lead { direction:rtl; font-size:9pt; margin:1mm 0 3mm 0; }
...
.notes { direction:rtl; margin-top:3mm; border:1px solid #30246C; border-radius:2mm; padding:2.5mm 4mm; font-size:9pt; color:#30246C; }
...
<div className="mbar">
  <div className="box"><div className="k">رقم الطلب</div><div className="v">RFQ-2026-0153</div></div>
  <div className="box"><div className="k">التاريخ</div><div className="v">20 / 06 / 2026</div></div>
  <div className="box"><div className="k">آخر موعد للعرض</div><div className="v">24 / 06 / 2026</div></div>
  <div className="box"><div className="k">صلاحية العرض</div><div className="v">30 يوماً</div></div>
</div>
<div className="to"><b>إلى:</b> السادة / المورد المحترم &nbsp;&nbsp;|&nbsp;&nbsp; <b>المشروع:</b> توريد مواد لمشروع طرق – الكويت</div>
<div className="lead">يرجى تقديم أفضل أسعاركم للأصناف أدناه:</div>
<table><thead><tr>
