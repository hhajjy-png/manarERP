export default function QuotationDesign2Blank() {
  return (
    <>
      <style>{`
...
.mbar .box { flex:1; border:1px solid #30246C; } .mbar .box+.box { border-right:none; }
.mbar .k { background:#30246C; color:#fff; font-weight:800; font-size:8pt; padding:1.5mm; text-align:center; }
.mbar .v { padding:2mm; text-align:center; font-size:9pt; min-height:8mm; }
.to { direction:rtl; border:1px dashed #30246C; border-radius:2mm; padding:3mm 4mm; font-size:9.5pt; color:#30246C; margin-bottom:2mm; }
.to b { font-weight:800; }
.subj { direction:rtl; font-size:9.5pt; margin:1mm 0 3mm 0; } .subj b { color:#30246C; font-weight:800; }
table { width:100%; border-collapse:collapse; direction:rtl; }
th,td { border:1px solid #30246C; text-align:center; vertical-align:middle; padding:1.9mm 1mm; font-size:9pt; }
thead th { background:#eee9f5; color:#30246C; font-weight:800; }
td.d { text-align:right; }
.c1{width:6%} .c2{width:47%} .c3{width:10%} .c4{width:10%} .c5{width:13.5%} .c6{width:13.5%}
.tot { direction:rtl; display:flex; justify-content:flex-start; }
.tot .cell { border:1px solid #30246C; border-top:none; padding:2mm 8mm; font-weight:800; color:#fff; background:#30246C; font-size:10pt; }
.terms { direction:rtl; margin-top:3mm; border:1px solid #30246C; border-radius:2mm; padding:2.5mm 4mm; font-size:8.8pt; color:#30246C; }
.terms h4 { margin:0 0 1mm; font-size:9.5pt; } .terms ul { margin:0; padding-right:5mm; line-height:1.9; }
...
.sign .ln { display:inline-block; width:50mm; border-bottom:1px dotted #30246C; margin-top:10mm; } .sign .col { text-align:center; }
...
<div className="ttl"><div className="a">عرض سعر</div><div className="b">Price Quotation</div></div>
<div className="mbar">
  <div className="box"><div className="k">رقم العرض</div><div className="v">QT-2026-0061</div></div>
  <div className="box"><div className="k">التاريخ</div><div className="v">20 / 06 / 2026</div></div>
  <div className="box"><div className="k">صلاحية العرض</div><div className="v">15 يوماً</div></div>
</div>
<div className="to"><b>إلى:</b> السادة / مصنع الخليج للأسفلت ذ.م.م &nbsp;|&nbsp; <b>عناية:</b> إدارة المشاريع</div>
<div className="subj"><b>الموضوع:</b> عرض سعر – خدمات نقل أسفلت (خلطة ساخنة)</div>
<table><thead><tr>
...
</tr></thead><tbody><tr><td>1</td><td className="d">نقل أسفلت خلطة ساخنة – داخل المدينة (حتى 30 كم)</td><td>نقلة</td><td>25</td><td>20.000</td><td>500.000</td></tr><tr><td>2</td><td className="d">نقل أسفلت خلطة ساخنة – مسافة (30 – 60 كم)</td><td>نقلة</td><td>15</td><td>28.000</td><td>420.000</td></tr><tr><td>3</td><td className="d">نقل أسفلت خلطة ساخنة – مسافة (أكثر من 60 كم)</td><td>نقلة</td><td>8</td><td>38.000</td><td>304.000</td></tr><tr><td>4</td><td className="d">رسوم انتظار إضافي بالموقع (بعد ساعتين)</td><td>ساعة</td><td>10</td><td>6.000</td><td>60.000</td></tr></tbody></table>
<div className="tot"><div className="cell">الإجمالي (د.ك) : 1,284.000</div></div>
<div className="terms"><h4>الشروط والأحكام</h4><ul><li>الأسعار بالدينار الكويتي وتشمل أجور السائق والوقود.</li><li>لا تشمل الأسعار أي رسوم حكومية أو تصاريح خاصة.</li><li>صلاحية العرض 15 يوماً من تاريخه.</li><li>الدفع خلال 30 يوماً من تاريخ الفاتورة.</li></ul></div>
<div className="sign">
  <div className="col">المخوّل بالتوقيع<div className="ln"></div></div>
  <div className="col">ختم الشركة<div className="ln"></div></div>
</div>
<div className="foot">
