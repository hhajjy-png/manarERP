export default function QuotationDesign3Blank() {
  return (
    <>
      <style>{`
...
.subj { direction:rtl; font-size:9.5pt; margin:0 0 3mm 0; } .subj b { color:#30246C; font-weight:800; }
...
tfoot td { font-weight:800; color:#30246C; border-bottom:2px solid #30246C; border-top:2px solid #30246C; }
...
.grid2 ul { margin:0; padding-right:4mm; line-height:1.9; }
...
<div className="meta">
  <b>رقم العرض:</b> QT-2026-0061 <span className="sep">•</span> <b>التاريخ:</b> 20 / 06 / 2026 <span className="sep">•</span> <b>صلاحية العرض:</b> 15 يوماً<br />
  <b>إلى:</b> السادة / مصنع الخليج للأسفلت ذ.م.م <span className="sep">•</span> <b>عناية:</b> إدارة المشاريع
</div>
...
<div className="grid2">
  <div className="b"><h4>الشروط والأحكام</h4><ul><li>الأسعار بالدينار الكويتي وتشمل أجور السائق والوقود.</li><li>لا تشمل الأسعار أي رسوم حكومية أو تصاريح خاصة.</li><li>صلاحية العرض 15 يوماً من تاريخه.</li><li>الدفع خلال 30 يوماً من تاريخ الفاتورة.</li></ul></div>
  <div className="b"><h4>المبلغ كتابةً</h4>ألف ومائتان وأربعة وثمانون ديناراً كويتياً لا غير</div>
</div>
<div className="sign">
