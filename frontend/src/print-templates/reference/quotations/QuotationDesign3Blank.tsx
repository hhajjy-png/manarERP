...
import styles from './QuotationDesign3.module.css';
...
<div className={styles.meta}>
  <b>رقم العرض:</b> QT-2026-0061 <span className={styles.sep}>•</span> <b>التاريخ:</b> 20 / 06 / 2026 <span className={styles.sep}>•</span> <b>صلاحية العرض:</b> 15 يوماً<br />
  <b>إلى:</b> السادة / مصنع الخليج للأسفلت ذ.م.م <span className={styles.sep}>•</span> <b>عناية:</b> إدارة المشاريع
</div>
...
<div className={styles.grid2}>
  <div className={styles.b}><h4>الشروط والأحكام</h4><ul><li>الأسعار بالدينار الكويتي وتشمل أجور السائق والوقود.</li><li>لا تشمل الأسعار أي رسوم حكومية أو تصاريح خاصة.</li><li>صلاحية العرض 15 يوماً من تاريخه.</li><li>الدفع خلال 30 يوماً من تاريخ الفاتورة.</li></ul></div>
  <div className={styles.b}><h4>المبلغ كتابةً</h4>ألف ومائتان وأربعة وثمانون ديناراً كويتياً لا غير</div>
</div>
