 ...
 *
 * الشارة «مرتبط بدفعة مقدَّمة» مؤشّر بصري فقط: تُشتق لحظة العرض من مطابقة تاريخ صف
 * «بدل الإجازة» مع تاريخ دفعة مقدَّمة على الإجازة لنفس الموظف. لا مفتاح أجنبي، لا تبعية
 * حسابية، ولا مزامنة تلقائية — إزالة هذا الملف بالكامل لا تؤثر في أي احتساب.
 */
...
/** true إذا وُجدت دفعة مقدَّمة على الإجازة بنفس اليوم (مؤشّر بصري فقط، بلا ربط منطقي). */
