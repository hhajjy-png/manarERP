 ...
 *
 * التشغيل من قسم النتيجة لا من زرّ البطاقة عمدًا: زرّ البطاقة يستدعي `loadPreview`
 * عبر `setTimeout` بإغلاق مُلتقَط قبل تغيّر `selected`، فيعتمد على ترتيب الرسم. زرّ
 * القسم يُرسَم بعد الاختيار فيحمل التقرير المحدَّد فعلًا — مسار حتمي للاختبار.
 */
