...
export const FORM_CARDS: FormCard[] = [
  ...
  // إقرار دين موظف — ثلاثة قوالب مستقلة (العربية / English / हिन्दी) لنصّ رسمي واحد،
  // بشاشة إدخال واحدة وهندسة ورق شركة خاصة به (40mm أعلى / 20mm أسفل).
  { key: 'employee-debt-acknowledgment', route: 'employee-debt-acknowledgment', titleKey: 'page.debtAck.title', description: 'إقرار دين واستلام سلفة موظف بثلاثة قوالب رسمية (العربية / English / हिन्दी) للطباعة على ورق الشركة.', descriptionEn: 'Employee loan receipt and acknowledgment of debt, in three official templates (Arabic / English / Hindi), printed on company letterhead.', icon: '🧾', category: 'hr' },
