...
| **Branch / commits** | `feature/employee-debt-acknowledgment-form-v1` · `4842aaf9` (التنفيذ) · `bdb1689e` (التوثيق) · `975402e4` (نوع في اختبار) · `07efbf52` (التحسينات الوظيفية) · `58594cf3` (مساحة التوقيع) · `e57b0e92` (التحسينات النهائية: أربع صفحات وملحق مزدوج) · `35e31961` (اتجاه كل الجداول العربية) · `9e2f0b2e` (**دعم أكثر من 12 قسطاً**) |
