...
| **Branch / commits** | `feature/employee-debt-acknowledgment-form-v1` · `4842aaf9` (التنفيذ) · `bdb1689e` (التوثيق) · `975402e4` (نوع في اختبار) · `07efbf52` (التحسينات الوظيفية) · `58594cf3` (مساحة التوقيع) · `e57b0e92` (التحسينات النهائية: أربع صفحات وملحق مزدوج) · `35e31961` (اتجاه كل الجداول العربية) · `EXT_COMMIT` (**دعم أكثر من 12 قسطاً**) |
...
| **Tests** | **+278** (32 أمانة نصّ مقابل DOCX · 29 واجهة/هندسة · 80 حاسبة الأقساط والتقسيم · 60 عزل لغوي وبوابة وبيانات ثابتة ومساحة توقيع · 72 صفحات المستند والملحق واتجاه الجداول · 5 خادم) — كلها ناجحة. الحزمة الأمامية كاملةً: **4481/4484** |
...
| **التقرير الكامل** | [`docs/EMPLOYEE_DEBT_ACKNOWLEDGMENT_V1.md`](docs/EMPLOYEE_DEBT_ACKNOWLEDGMENT_V1.md) — خريطة الحقول الكاملة، أدلّة القياس، و19 Finding (`F-14` مُغلق؛ و`F-17`–`F-19` جديدة تنتظر قرارًا). وتقرير القياس نفسه محفوظ في `docs/employee-debt-acknowledgment-v1.geometry.json` ويقرؤه اختبار آليّ |
