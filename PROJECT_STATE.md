...
|-------|-------|
| **Branch** | `production` |
| **HEAD** | `b98bcdd` — feat(frontend): Invoice & Expenses Operations Pack — Frontend Pass |
| **Merge Commit** | `569bdca` — Merge Invoice & Expenses Operations Pack into production |
| **Latest stable tag** | `stable-invoice-expenses-operations-pack-v1` |
...
|-------|-------|-------|--------|
| Backend (Vitest) | 33 | 591 | All passing |
...
### TypeScript validation (Invoice & Expenses Operations Pack — clean run)
...
cd backend && npm test                     ✅ 591/591 (33 files)
...
*Last updated: 2026-06-23 — Invoice & Expenses Operations Pack released. HEAD `b98bcdd`. Merge commit `569bdca`. Tag `stable-invoice-expenses-operations-pack-v1`. 591 backend tests (33 files) / 507 frontend tests (24 files). Full-stack: backend FK conflict guards + expenses period stats + reports; frontend Smart Price Picker + period cards + billing period polish + i18n cleanup + conflict message UI. No migration, no schema changes, no IPC, no new npm packages.*
