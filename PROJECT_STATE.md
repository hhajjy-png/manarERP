...
|-------|-------|
| **Branch** | `production` |
| **HEAD** | `4ab4cac` — Merge Statement Center Phase 1 into production |
| **Merge Commit** | `4ab4cac` — Merge Statement Center Phase 1 into production |
| **Latest stable tag** | `stable-statement-center-phase1-v1` |
...
|-------|-------|-------|--------|
| Backend (Vitest) | 36 | 628 | All passing |
...
### TypeScript validation (Statement Center Phase 1 — clean run)
...
cd backend && npm test                     ✅ 628/628 (36 files)
...
*Last updated: 2026-06-24 — Statement Center Phase 1 released. HEAD `4ab4cac` (merge commit). Tag `stable-statement-center-phase1-v1`. 628 backend tests (36 files) / 507 frontend tests (24 files). Shared Statement Engine with entity-type-specific AR/AP sign convention. 4 REST endpoints (/api/statements/customers|suppliers/:id[/export]). Frontend: Statements.tsx with 2-tab layout, entity picker, filter bar, 5 summary cards, color-coded table, Excel export. Navigation: كشف الحساب. Permissions: statements.read + statements.export. No migration, no IPC, no new npm packages. Gemini APPROVED ✅.*
