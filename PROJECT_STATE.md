...
|-------|-------|
| **Branch** | `production` |
| **HEAD** | `c65da20` — Merge Financial Center Phase 2 into production |
| **Merge Commit** | `c65da20` — Merge Financial Center Phase 2 into production |
| **Latest stable tag** | `stable-financial-center-phase2-v1` |
...
|-------|-------|-------|--------|
| Backend (Vitest) | 45 | 718 | All passing |
...
### TypeScript validation (Financial Center Phase 2 — clean run)
...
cd backend && npm test                     ✅ 718/718 (45 files)
...
*Last updated: 2026-06-24 — Financial Center Phase 2 released. HEAD `c65da20` (merge commit). Tag `stable-financial-center-phase2-v1`. 718 backend tests (45 files) / 516 frontend tests (25 files). Financial Center Phase 2: GL Report, Trial Balance, Aging Report, Journal Book, Financial Reports tab, Financial Dashboard tab, Dashboard مالي tab (localStorage tab persistence, financialdashboard.read guard), Statements migration banner. 11 new REST endpoints under /api/financial/. New shared services: dashboard-summary.service.ts (45s TTL cache), summary.export.adapter.ts. New permission: financialdashboard.read. M9 BalanceDisplay (formatBalance absolute + مدين/دائن). 64 files changed, 6292 insertions. No migration, no IPC, no new npm packages. Gemini APPROVED ✅.*
