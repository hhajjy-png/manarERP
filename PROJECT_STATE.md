...
| **Branch / commits** | `feature/employee-debt-acknowledgment-form-v1` · `4842aaf9` (التنفيذ) · `bdb1689e` (التوثيق) · `975402e4` (نوع في اختبار) · `07efbf52` (التحسينات الوظيفية) · `58594cf3` (مساحة التوقيع) · `e57b0e92` (التحسينات النهائية: أربع صفحات وملحق مزدوج) · `35e31961` (اتجاه كل الجداول العربية) · `9e2f0b2e` (دعم أكثر من 12 قسطاً) · `TWEAKS_COMMIT` (**تسمية عمود الرصيد · الرصيد عند التوقيع · قيم افتراضية وآيبان ثابت**) |
...
| **Tests** | **+295** (35 أمانة نصّ مقابل DOCX · 29 واجهة/هندسة · 80 حاسبة الأقساط والتقسيم · 60 عزل لغوي وبوابة وبيانات ثابتة ومساحة توقيع · 86 صفحات المستند والملحق واتجاه الجداول والرصيد والقيم الافتراضية · 5 خادم) — كلها ناجحة. الحزمة الأمامية كاملةً: **4498/4501** |
...
| **التقرير الكامل** | [`docs/EMPLOYEE_DEBT_ACKNOWLEDGMENT_V1.md`](docs/EMPLOYEE_DEBT_ACKNOWLEDGMENT_V1.md) — خريطة الحقول الكاملة، أدلّة القياس، و19 Finding (`F-10` و`F-14` مُغلقان؛ و`F-17`–`F-19` تنتظر قرارًا). وتقرير القياس نفسه محفوظ في `docs/employee-debt-acknowledgment-v1.geometry.json` ويقرؤه اختبار آليّ |
