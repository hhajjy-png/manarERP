...
export const employeeCompensationController = {
  ...
  // `async` رغم أن المحرّك متزامن: `asyncHandler` يلتقط الرفض لا الرمي المتزامن،
  // فتوحيد الشكل يضمن أن أي خطأ تحقّق يمرّ بمعالج الأخطاء العام لا بمنتصف الطلب.
  async preview(req: Request, res: Response) {
    ok(res, service.preview(req.body));
  },
