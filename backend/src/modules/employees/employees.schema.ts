...
export const leaveSchema = z.object({
  body: z.object({
    ...
    /**
     * تاريخ تقديم الطلب — بيانات طلب الإجازة المطبوع، اختياري.
     * تختاره الواجهة (افتراضه اليوم عند الإنشاء) بدل أن يفرضه القالب وقت الطباعة.
     * لا يدخل أي احتساب ولا يقيَّد بالتاريخين: الطلب قد يُقدَّم قبل الإجازة أو بعدها.
     */
    requestDate: dateOnlySchema.optional(),
  }),
});
