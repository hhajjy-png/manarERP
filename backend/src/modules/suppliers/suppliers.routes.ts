...
router.get('/:id/force', requireRole(ROLES.SYSTEM_ADMIN), asyncHandler(suppliersController.forceRemovePreview));
...
router.delete('/:id/force', requireRole(ROLES.SYSTEM_ADMIN), asyncHandler(suppliersController.forceRemove));
