 ...
 *
 * ولماذا هذه الأربعة: **1** حالة القسط الواحد، ولها في البند 4 صيغتها الخاصة (لا
 * «قسط عادي» ولا «أخير»)؛ **5** مثال مالك المنتج الأصلي، وصفحةُ ملحق واحدة لكل نسخة؛
