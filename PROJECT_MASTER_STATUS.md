...
| **Current HEAD** | `7d7b4f99` — merge of `feature/document-studio-ux-polish-pack-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-document-studio-ux-polish-pack-v1` (merge commit `7d7b4f99`) | High |
| **Previous stable tag** | `stable-document-studio-v1` (`c197e834`) | High |
