...
| **Current HEAD** | `c197e834` — merge of `feature/document-studio-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-document-studio-v1` (merge commit `c197e834`) | High |
| **Previous stable tag** | `stable-collection-analysis-page-v1` (`3e684831`) | High |
