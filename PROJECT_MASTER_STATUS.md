...
| **Current HEAD** | `3e684831` — merge of `feature/collection-analysis-page-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-collection-analysis-page-v1` (merge commit `3e684831`) | High |
| **Previous stable tag** | `stable-administrative-forms-barcode-enhancement-pack-v1` (`712dad62`) | High |
