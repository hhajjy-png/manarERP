...
| **Current HEAD** | `e0467d62` — merge of `feature/view-zoom-persistence-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-view-zoom-persistence-pack-v1` (merge commit `e0467d62`) | High |
| **Previous stable tag** | `stable-cheque-template-persistence-legacy-recovery-pack-v1` (`91d3f987`) | High |
