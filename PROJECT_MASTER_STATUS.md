...
| **Current HEAD** | `9ec31d16` — merge of `feature/financial-position-analysis-audit-pdf-fix-pack-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-financial-position-analysis-audit-pdf-fix-pack-v1` (merge commit `9ec31d16`) | High |
| **Previous stable tag** | `stable-document-studio-ux-polish-pack-v1` (`7d7b4f99`) | High |
