...
| **Current HEAD** | `39da6141` — merge of `feature/zero-data-loss-certification-pack-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-user-data-persistence-legacy-recovery-pack-v1` (merge commit `39da6141`) | High |
| **Previous stable tag** | `stable-view-zoom-persistence-pack-v1` (`e0467d62`) | High |
