...
| **Current HEAD** | `91d3f987` — merge of `feature/cheque-template-persistence-migration-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-cheque-template-persistence-legacy-recovery-pack-v1` (merge commit `91d3f987`) | High |
| **Previous stable tag** | `stable-production-release-2026.2.0` (`f12adf90`) | High |
...
### Latest Release — `stable-cheque-template-persistence-legacy-recovery-pack-v1` (`91d3f987`, 2026-08-08)
