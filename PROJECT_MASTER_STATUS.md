...
| **Current HEAD** | `0712c905` — merge of `feature/production-release-2026.3.1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-production-release-2026.3.1` (merge commit `0712c905`) | High |
| **Previous stable tag** | `stable-view-zoom-manual-save-pack-v1` (`6d02c08b`) | High |
| **Application version** | `2026.3.1` — calendar versioning; installer `AlManarERP-Setup-2026.3.1.exe` (131.75 MiB, Windows 10/11 x64, per-user install under `%AppData%`) | High |
