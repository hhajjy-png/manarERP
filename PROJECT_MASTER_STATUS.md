...
| **Release-log structure** | `PROJECT_STATE.md` holds the current release + the **15** most recent `## Previous Release` entries. The **172** older entries were rotated out verbatim on 2026-09-08 into `docs/history/PROJECT_STATE_ARCHIVE_*.md` (4 files) — index in `docs/history/README.md`, full accounting in `docs/history/ROTATION_MANIFEST_V1.md`. **No release history is duplicated into this file** | High |
