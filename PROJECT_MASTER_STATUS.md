...
| **Current HEAD** | `6d02c08b` — merge of `feature/view-zoom-manual-save-pack-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-view-zoom-manual-save-pack-v1` (merge commit `6d02c08b`) | High |
| **Previous stable tag** | `stable-production-release-2026.3.0` (`ec874c8b`) | High |
| **Application version** | `2026.3.0` — unchanged by this release (source-only, no new installer built) | High |
