...
> Last refreshed: 2026-08-04 (previously 2026-08-04, 2026-08-04, 2026-08-04, 2026-08-04, 2026-08-03, 2026-08-03, 2026-08-02, 2026-08-02, 2026-08-01, 2026-08-01, 2026-08-01, 2026-08-01, 2026-08-01, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-30, 2026-07-30, 2026-07-30, 2026-07-25, 2026-07-25, 2026-07-24, 2026-07-24, 2026-07-23, 2026-07-23, 2026-07-23, 2026-07-20, 2026-07-20, 2026-07-20, 2026-07-20, 2026-07-20, 2026-07-19, 2026-07-17, 2026-07-01) · This refresh is a release-tracking update, not a read-only audit — it accompanies the Financial Analysis Center v1 release: a new read-only executive page at `#/financial-analysis` (guarded by `reports.read`) with eight table-only sections — profitability, revenue, expenses, collections, receivables, monthly performance, top lists and financial indicators — built on a new `financialAnalysis` module split into a shared type contract, a single Prisma dataset layer, a pure compute layer and thin service/controller/routes. Business rules are not redefined: revenue, expenses, collections and P&L come from `shared/services/operational.reporting`, so the page matches the dashboard and the P&L report by definition. One dataset load per request feeds all eight sections; every section KPI is derived from its own table rows. Ships an 11-worksheet Excel export (shared `buildExcelWorkbook`) and a landscape multi-page PDF export (shared `composeStyledFromNode` + Electron `exportPdfFromHtml`), plus a root-cause fix to `useT()`'s unstable identity that had produced an unbounded render/fetch loop. 32 files, backend + frontend; no Prisma/schema/migration/permission-key/Electron change. The previous refresh accompanied the Employee Table Column Optimization Pack v1 release: narrows the nationality column and 8 neighboring Employees-table columns so the license-expiry column sits ~209px closer to the visible viewport at the project's standard 1440×900 window, without reordering columns or touching sort/filter/search/data logic. 1 file, frontend-only; no Prisma/schema/backend change.
...
| **Current HEAD** | `4a672e70` — merge of `feature/financial-analysis-center-v1` (documentation commit to follow) | High |
| **Current stable tag** | `stable-financial-analysis-center-v1` (merge commit `4a672e70`) | High |
| **Previous stable tag** | `stable-employee-table-column-optimization-pack-v1` (`7cb24752`) | High |
