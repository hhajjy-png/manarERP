...
> Last refreshed: 2026-08-15 (previously 2026-08-15, 2026-08-14, 2026-08-11, 2026-08-10, 2026-08-10, 2026-08-10, 2026-08-09, 2026-08-08, 2026-08-08, 2026-08-08, 2026-08-07, 2026-08-07, 2026-08-07, 2026-08-06, 2026-08-06, 2026-08-05, 2026-08-05, 2026-08-04, 2026-08-04, 2026-08-04, 2026-08-04, 2026-08-04, 2026-08-03, 2026-08-03, 2026-08-02, 2026-08-02, 2026-08-01, 2026-08-01, 2026-08-01, 2026-08-01, 2026-08-01, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-31, 2026-07-30, 2026-07-30, 2026-07-30, 2026-07-25, 2026-07-25, 2026-07-24, 2026-07-24, 2026-07-23, 2026-07-23, 2026-07-23, 2026-07-20, 2026-07-20, 2026-07-20, 2026-07-20, 2026-07-20, 2026-07-19, 2026-07-17, 2026-07-01) · This refresh is a release-tracking update, not a read-only audit — it accompanies **Privacy Toggle Tier A v1**: an audit + fix of the top-bar lock button's "hide/show financial numbers" feature. The button itself was never broken — `togglePrivacy()` is a plain boolean flip with no stale closures or memoization — the defect was coverage: `privacyMode` was read in only 3 files out of ~90 that display money, since most amounts went through separate helpers (`money()`, `MoneyText`, `MoneyCell`, `fcCurrency()`, chart formatters, print templates) that never consulted the privacy store. This release (Tier A) makes the two shared components `MoneyText`/`MoneyCell` in `config/modules.tsx` privacy-aware, reusing `PrivateAmount`'s existing `pm-mask`/`pm-real` dual-span pattern and its exported `buildLevel1Mask()` — fixing ~60 existing call sites with zero call-site changes, print output unaffected (real values always print). Tier B (plain-function `money()`/`fcCurrency()` calls outside JSX, chart tooltip/axis formatters, print-preview screens, the AI `ResultCard`) is deferred by design, documented explicitly as out of scope rather than silently left broken. Presentation only — zero calculation, permission, or schema change. 4 files (2 modified, 2 new). The prior refresh accompanied Employee Entitlements Leave Management Pack v1.
...
### Latest Release — `stable-privacy-toggle-tier-a-v1` (`7cb1c738`, 2026-08-15)
